      ...
      <div className="w-full h-full mx-auto px-8 flex flex-col justify-center   ">
        <h1
          className={`text-4xl sm:text-6xl md:text-7xl font-bold  text-center ${
            !isDark ? "text-gray-900" : "text-[#fafafa]"
          }`}
        >
          Diego Cattaneo
        </h1>
        <h2
          className={`text-3xl sm:text-5xl md:text-6xl font-semibold  text-center ${
            !isDark ? "text-gray-800" : "text-[#fff]"
          }`}
        >
        ...
        <div className="flex justify-center">
          <p
            className={`text-center sm:text-left   py-4 max-w-[700px] text-xs  sm:text-sm md:text-base tracking-wider ${
              !isDark ? "text-gray-950" : "text-[#fff]"
            }`}
          >
            {language
        ...
        <div className="flex justify-center items-center">
          <Link to="work" smooth={true} offset={-20} duration={700}>
            <button
              className={` group border-[1px] rounded-xl px-6 py-3 flex items-center   ${
                !isDark
